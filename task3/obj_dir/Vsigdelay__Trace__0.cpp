...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+8,(vlSelf->sigdelay__DOT____Vcellout__addrCounter__count),8);
    bufp->chgCData(oldp+9,((0xffU & ((IData)(vlSelf->sigdelay__DOT____Vcellout__addrCounter__count) 
